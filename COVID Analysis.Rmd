...
USA_Animated_New_Cases_Map<-plot_usmap(data=US_Cases_State,values="per_capita_running_average") +
  ...
  transition_states(Date)
anim_save("US_New_Cases_Map.gif",animate(USA_Animated_New_Cases_Map, nframes = 2*length(unique(US_Cases_State$Date)),height = 600, width =800))
...
USA_Animated_New_Deaths_Map<-plot_usmap(data=US_Deaths_State,values="per_capita_running_average") +
  ...
  transition_states(Date)
anim_save("US_New_Deaths_Map.gif",animate(USA_Animated_New_Deaths_Map, nframes = 2*length(unique(US_Deaths_State$Date)),height = 600, width =800))
```
![](US_Cases.gif)
![](US_Cases_Map.gif)
![](US_Deathss.gif)
