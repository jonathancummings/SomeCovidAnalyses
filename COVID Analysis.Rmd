...
```{r animation, message=FALSE, warning=FALSE, echo=FALSE}
...
USA_Animated_Cases<-ggplot(US_Cases_State,aes(x=order,y=Cases_Percent))+
  ...
  geom_text(aes(y = Cases_Percent, label = State), vjust = -0.5)+
...
animate(USA_Animated_Cases, nframes = 2 * length(unique(US_Cases_State$Date)),height = 600, width =1000)
...
USA_Animated_Cases_Map<-plot_usmap(data=US_Cases_State,values="Cases_Percent") +
  ...
  transition_states(Date)
animate(USA_Animated_Cases_Map, nframes = 2*length(unique(US_Deaths_State$Date)),height = 600, width =800)
anim_save("US_Cases_Map.gif")
...
animate(USA_Animated_Deaths, nframes = 2 * length(unique(US_Cases_State$Date)),height = 600, width =1000)
anim_save("US_Deathss.gif")
...
USA_Animated_Deaths_Map<-plot_usmap(data=US_Deaths_State,values="Deaths_Percent") +
  ...
  transition_states(Date)
animate(USA_Animated_Deaths_Map, nframes = 2*length(unique(US_Deaths_State$Date)),height = 600, width =800)
anim_save("US_Deaths_Map.gif")
```
